    ...
    .then(function() {
      ...
      vars.files = Promise.mapSeries(Array(vars.numberOfRecords),function() {
        ...
        return records.pull(vars.fileNameLength).then(function(fileNameBuffer) {
          ...
          let charset = jschardet.detect(fileNameBuffer);
          let decodedFilename = ['windows-1252','ISO-8859-2'].indexOf(charset.encoding)>=0 ? iconv.decode(fileNameBuffer, 'cp437') : iconv.decode(fileNameBuffer, 'utf8')
          vars.path = decodedFilename;
